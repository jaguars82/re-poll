  ...
  <div>
    <header class="vff-header">
      <div class="f-container">
        ...
        <svg fill="#FFFFFF" height="100" width="100" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
          <g>
            <g>
              <g>
